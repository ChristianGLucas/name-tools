// Shared test context for name-tools node unit tests. Not a node and not a
// test file itself (no describe/it), so it is neither registered as a node
// nor collected by jest.
import {
  AxiomContext,
  AxiomLogger,
  AxiomSecrets,
